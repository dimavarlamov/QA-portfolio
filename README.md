...
Приложение позволяет просматривать каталог автомобилей, фильтровать их по различным параметрам, добавлять в избранное и оформлять покупку.
